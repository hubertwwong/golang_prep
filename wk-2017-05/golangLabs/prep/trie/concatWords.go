...
so passes. FUCK YAY.
2 hacks.
1 was a pointer to a boolean flag the result as soon as you find it.
2nd hack was to check for this boolean and if its return just return true to avoid computation..
